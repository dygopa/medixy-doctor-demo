...
const fakers = {
  ...
  fakePhotos() {
    const photos = [];
    for (let i = 0; i < 15; i++) {
      photos[photos.length] = "/src/assets/images/fakers/profile-" + _.random(1, 15) + ".jpg";
    }
  ...
  fakeImages() {
    const images = [];
    for (let i = 0; i < 15; i++) {
      images[images.length] = "/src/assets/images/fakers/preview-" + _.random(1, 15) + ".jpg";
    }
    ...
    const foods = [
      {
        name: "Vanilla Latte",
        image:
         "/src/assets/images/fakers/food-beverage-1.jpg"
      },
      {
        name: "Milkshake",
        image:
         "/src/assets/images/fakers/food-beverage-2.jpg"
      },
      {
        name: "Soft Drink",
        image:
         "/src/assets/images/fakers/food-beverage-3.jpg"
      },
      {
        name: "Root Beer",
        image:
         "/src/assets/images/fakers/food-beverage-4.jpg"
      },
      {
        name: "Pocari",
        image:
         "/src/assets/images/fakers/food-beverage-5.jpg"
      },
      {
        name: "Ultimate Burger",
        image:
         "/src/assets/images/fakers/food-beverage-6.jpg"
      },
      {
        name: "Hotdog",
        image:
         "/src/assets/images/fakers/food-beverage-7.jpg"
      },
      {
        name: "Avocado Burger",
        image:
         "/src/assets/images/fakers/food-beverage-8.jpg"
      },
      {
        name: "Spaghetti Fettucine Aglio with Beef Bacon",
        image:
         "/src/assets/images/fakers/food-beverage-9.jpg"
      },
      {
        name: "Spaghetti Fettucine Aglio with Smoked Salmon",
        image:
         "/src/assets/images/fakers/food-beverage-10.jpg"
      },
      {
        name: "Curry Penne and Cheese",
        image:
         "/src/assets/images/fakers/food-beverage-11.jpg"
      },
      {
        name: "French Fries",
        image:
         "/src/assets/images/fakers/food-beverage-12.jpg"
      },
      {
        name: "Virginia Cheese Fries",
        image:
         "/src/assets/images/fakers/food-beverage-13.jpg"
      },
      {
        name: "Virginia Cheese Wedges",
        image:
         "/src/assets/images/fakers/food-beverage-14.jpg"
      },
      {
        name: "Fried/Grilled Banana",
        image:
         "/src/assets/images/fakers/food-beverage-15.jpg"
      },
      {
        name: "Crispy Mushroom",
        image:
         "/src/assets/images/fakers/food-beverage-16.jpg"
      },
      {
        name: "Fried Calamari",
        image:
         "/src/assets/images/fakers/food-beverage-17.jpg"
      },
      {
        name: "Chicken Wings",
        image:
         "/src/assets/images/fakers/food-beverage-18.jpg"
      },
      {
        name: "Snack Platter",
        image:
         "/src/assets/images/fakers/food-beverage-19.jpg"
      },
    ];
