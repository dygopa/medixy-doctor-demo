...
import MedicalCentersCreateIndex from "(presentation)/components/Admin/MedicalCenters/MedicalCentersCreate/MedicalCentersCreateIndex";
...
export default async function DashboardPage() {
  ...
  return (
    <AdminAppLayout
      user={user}
      title="Nuevo centro médico"
      pathname={AdminMedicalCentersRoutesEnum.MedicalCentersCreate}
    >
      <MedicalCentersCreateIndex />
    </AdminAppLayout>
  );
}
