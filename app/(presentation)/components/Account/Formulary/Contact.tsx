                ...
                <div className="w-full flex flex-wrap justify-between items-center gap-6 relative">
                    ...
                    <div className="w-full grid grid-cols-4 justify-start items-center gap-3">
                        <div className="flex flex-col justify-between items-start relative gap-1">
                            <p className="text-[13px] w-fit text-slate-900 font-medium mb-2">Teléfono de contacto</p>
                            <FormInput
                                type={"text"}
                        ...
                        <div className="flex flex-col justify-between items-start relative gap-1">
                            <p className="text-[13px] w-fit text-slate-900 font-medium mb-2">Sitio web</p>
                            <FormInput
                                type={"text"}
