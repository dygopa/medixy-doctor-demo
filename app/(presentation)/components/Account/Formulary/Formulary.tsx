...
export default function Formulary({ account, setAccount }: IFormularyProps) {
  ...
  return (
    <div>
      ...
      <AlertComponent variant="error" show={error !== null} description={"Ha ocurrido un error actualizando la cuenta"} />
      <AlertComponent variant="success" show={successful === true} description="Cuenta actualizada exitosamente" />

      <div className="w-full flex justify-between items-center">
        <div className="w-[50%]">
          <h2 className="mr-5 text-2xl font-bold truncate">Mi cuenta</h2>
          <p className='font-light text-slate-500 text-base my-3'>Completa la información de tu cuenta para poder desbloquear otras funciones dentro de la plataforma</p>
        </div>
