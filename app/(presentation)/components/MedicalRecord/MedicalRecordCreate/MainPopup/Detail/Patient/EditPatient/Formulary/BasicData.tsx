...
import { IMedicalRecordCreateContext, MedicalRecordCreateContext } from "(presentation)/components/MedicalRecord/MedicalRecordCreate/context/MedicalRecordCreateContext";
...
export default function BasicData({
  ...
  async function handleChangeAvatar(e: ChangeEvent<HTMLInputElement>) {
    ...
    updateAvatar(obj, values.id.toString())(dispatch);
  }
