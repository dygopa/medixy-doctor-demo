        ...
        {[...(appointments as Array<any>)].map((data, i) => {
          return (
            <div
              key={i}
              onClick={() => {
                appointmentDetail({ ...data, appoinmentId: data["id"] })(
                  dispatchSchedule
                );
                changeStatusPopup(true)(dispatchSchedule);
                changeTypePopup(2)(dispatchSchedule);
              }}
            ...
            >
              ...
              <div className="w-[53%] h-full flex flex-col justify-center items-start overflow-hidden">
                ...
                <p className="font-light text-sm text-slate-500 w-full whitespace-nowrap text-ellipsis">
                  {data["nombre"]}
                </p>
              </div>
              <div className="w-[40%] h-full flex flex-col justify-center items-end">
                <div className="w-full flex justify-end items-center gap-1 overflow-hidden">
                  <p className="font-semibold text-[12px] text-slate-900 whitespace-nowrap text-ellipsis">
                    {moment(data["fechaReserva"]).utc().format("DD/MM")} -{" "}
