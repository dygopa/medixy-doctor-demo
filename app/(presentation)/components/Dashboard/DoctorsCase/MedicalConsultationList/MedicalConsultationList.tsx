      ...
      <div className="w-full h-full py-3 flex flex-col justify-start items-start gap-4 rounded-md overflow-y-auto">
        {[...(appointments as Array<any>)].map((data, i) => {
          return(
            ...
            className="transition cursor-pointer relative w-full min-h-[9vh] h-[9vh] max-h-[14vh] bg-white hover:bg-slate-100 flex justify-between items-center p-3 gap-2 box-border rounded-md shadow-sm">
