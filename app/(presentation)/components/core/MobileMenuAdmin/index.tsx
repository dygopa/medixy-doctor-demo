...
import { FormattedMenu } from "(presentation)/(layouts)/AdminSideMenu/side-menu";
import {
  endNavigationOptions,
  navigationOptions,
} from "(presentation)/(layouts)/AdminSideMenu/side-options";
    ...
    >
      ...
      <div className="flex items-center w-full ml-3">
        ...
        {props.menu.subMenu && (
          ...
          >
            <Lucide icon="arrow-down" color="#fff" className="w-5 h-5" />
          </div>
        )}
      </div>
    </Link>
