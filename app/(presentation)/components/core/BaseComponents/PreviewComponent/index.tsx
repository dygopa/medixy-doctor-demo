        ...
        <pre className="relative grid">
          <code
            className={clsx([
              ...
              "before:content-['HTML'] before:font-roboto before:font-bold before:px-4 before:py-2 before:block before:absolute before:top-0 before:right-0 before:rounded-bl before:bg-slate-200 before:bg-opacity-70 before:dark:bg-darkmode-400",
