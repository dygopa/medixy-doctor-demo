  ...
  return (
    <Component
      className={twMerge([
        ...
        list.variant == "tabs" &&
          tab.selected &&
          "bg-white border-slate-200 border-b-transparent font-bold dark:bg-transparent dark:border-t-darkmode-400 dark:border-b-darkmode-600 dark:border-x-darkmode-400",
        list.variant == "tabs" &&
          !tab.selected &&
        ...
        list.variant == "link-tabs" &&
          tab.selected &&
          "border-b-primary font-bold dark:border-b-primary",
