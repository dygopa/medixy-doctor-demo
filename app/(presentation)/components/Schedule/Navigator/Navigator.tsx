...
export default function Navigator({selectedLocality}:{selectedLocality:ISelectedLocality,}) {
  ...
  const {
    ...
    return (
      <div className="w-full md:flex justify-between items-start gap-5">
        ...
        <div className="w-full mt-3 md:mt-0 lg:w-fit flex flex-row justify-center flex-wrap lg:flex-nowrap lg:justify-end items-center gap-2 h-full">
          <Button
            onClick={() => {
