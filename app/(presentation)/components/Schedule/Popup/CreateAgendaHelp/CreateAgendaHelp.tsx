            ...
            <div className="w-full flex flex-col justify-start items-start gap-5">
                <div className="w-full flex flex-col justify-start items-center gap-3">
                    <div className="w-full flex flex-col justify-start items-start gap-1 border-b pb-3">
                        <p className='font-semibold text-sm text-slate-900'>Qué es una ventana de atención</p>
                        <p className='font-normal text-sm text-slate-900'>Tu <b>ventana de atención</b> es el rango de horas en la cual los clientes podrán realizar citas</p>
                    </div>

                    <div className="w-full flex flex-col justify-start items-start gap-1 border-b pb-3">
                        <p className='font-semibold text-sm text-slate-900'>Qué pasa si tengo varios horarios</p>
                        <p className='font-normal text-sm text-slate-900'>Si tienes <b>varios horarios</b> para un servicio puedes crear otra <b>ventana de atención</b></p>
                    </div>

                    <div className="w-full flex flex-col justify-start items-start gap-1 border-b pb-3">
                        <p className='font-semibold text-sm text-slate-900'>Qué es un tiempo promedio de atención</p>
                        <p className='font-normal text-sm text-slate-900'>Si tienes <b>varios horarios</b> para un servicio puedes crear otra <b>ventana de atención</b></p>
                    </div>
                </div>
                <div className="w-full flex flex-col justify-start items-center gap-4">
                    <p className='font-normal text-sm text-slate-900'>Ejemplo practico de <b>varios horarios</b> de un servicio creados cómo <b>ventanas de atención</b></p>
