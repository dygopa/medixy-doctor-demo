...
export default function FiltersComponent({cancelFuntion, customRef}:{
  ...
  return (
    ...
    <div ref={customRef} className='w-full md:w-[60%] lg:w-[40%] h-screen md:min-h-[20vh] md:max-h-[70vh] lg:min-h-[20vh] lg:max-h-[70vh] overflow-y-auto flex flex-col justify-between items-start bg-white lg:rounded-md p-6 gap-8'>
      <div className="w-full flex flex-col justify-start items-start gap-5">
        ...
        <div className='relative w-full h-fit flex flex-col justify-start items-start gap-1'>
          ...
          {selectedLocality["title"] !== "" && <div className={twMerge([
            ...
            <div className="w-[90%] h-full flex flex-col justify-center items-start">
              <p className='font-semibold text-gray-950 text-[0.9rem]'>{selectedLocality["title"]}</p>
        ...
        <div className='relative w-full h-fit flex flex-col justify-start items-start gap-1'>
          ...
          {selectedService["title"] !== "" && <div className={twMerge([
            ...
            <div className="w-[90%] h-full flex flex-col justify-center items-start">
              <p className='font-semibold text-gray-950 text-[0.9rem]'>{selectedService["title"]}</p>
