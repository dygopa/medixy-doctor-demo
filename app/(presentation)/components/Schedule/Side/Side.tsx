...
const AppointmentComponent = ({onClick}:{
  ...
  return(
    <div onClick={onClick} className="relative w-full h-[12vh] bg-white flex justify-between items-center p-3 gap-2 box-border rounded-md shadow-sm">
      ...
      <div className="w-[60%] h-full flex flex-col justify-between items-start">
        ...
        <p className='font-medium text-sm text-slate-900'>Consulta general</p>
        <p className='font-light text-sm text-gray-700'>Dr. Ignacio Molina</p>
      </div>
      <div className="w-[24%] h-full flex flex-col justify-between items-end">
        <div className="w-full flex justify-end items-center gap-1">
          <p className='font-light text-[12px] text-gray-700'>09:00 am</p>
  ...
  return (
    <div className='w-1/3 flex flex-col justify-start items-center gap-3'>
      <div className="w-full flex justify-between items-center">
        <p className='font-light text-xl text-slate-900'>Mie - 10:35 am</p>
        <p className='cursor-pointer font-light text-sm text-gray-700'>Ver más</p>
      </div>
