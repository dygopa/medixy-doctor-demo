...
import DuePathologyList from './List/DuePathologyList'
import PercentageList from './List/PercentageList'
    ...
    <div className='md:grid grid-cols-2 gap-4'>
      ...
      >
        <div className="px-4 py-2 box h-full overflow-y-hidden">
          ...
          <div className="mt-4 h-[30vh] md:grid grid-cols-2 gap-4">
            <div>
              <p className="w-full text-left font-bold text-md text-slate-900 pb-1 border-b mb-2">
                Detalle
              </p>
              <PercentageList />
            </div>
