...
export default function Filters({ user }: IFiltersProps) {
  ...
  return (
    <div>
      ...
      {showFilters && (
        <div className="mt-4">
          <div className="lg:flex justify-between align-end">
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
              <div className="mb-3">
                <div className="font-medium text-left mb-3">Dirección</div>
