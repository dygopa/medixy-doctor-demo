  ...
  return (
    <div className="py-5 md:py-0 -mx-3 px-3 sm:-mx-8 sm:px-8 bg-primary dark:bg-transparent">
      ...
      <div className="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div
          className={clsx([
            "md:ml-[105px] xl:ml-[250px] rounded-[30px] md:rounded-[35px/50px_0px_0px_0px] min-w-0 min-h-screen max-w-full md:max-w-none bg-slate-100 flex-1 pb-10 px-4 md:px-6 relative dark:bg-darkmode-700",
