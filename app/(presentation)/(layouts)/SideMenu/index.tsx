        ...
        <div className="pb-5 pt-5 lg:pt-0 md:pt-0 xl:pt-0 md:py-0 -mx-3 px-3 sm:-mx-8 sm:px-8 bg-primary dark:bg-transparent h-[100vh] lg:overflow-hidden md:overflow-hidden overflow-auto">
          ...
          <PopupProvider>
            ...
            <div className="flex xl:mt-0 lg:mt-0 mt-0 md:mt-0 overflow-hidden h-[101vh]">
              {/* BEGIN: Side Menu */}
              <nav className="hidden md:block md:w-[105px] xl:w-[250px] pl-5 pr-6 py-5 overflow-hidden bg-primary z-10 h-[100vh] fixed">
                <Navigation />
              </nav>
              {/* END: Side Menu */}
              {/* BEGIN: Content */}
              <div
                className={clsx([
                  "xl:mt-0 lg:mt-0 md:mt-0 mt-[4rem] md:ml-[105px] xl:ml-[250px] overflow-y-auto h-auto rounded-[30px] md:rounded-[35px/50px_0px_0px_0px] w-0 max-w-full md:max-w-none bg-slate-100 flex-1 pb-10 px-4 md:px-6 relative",
